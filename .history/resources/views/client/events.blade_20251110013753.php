...
<section class="container mx-auto px-6 -mt-8 relative z-20">
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 ">
        <form method="GET" action="{{ route('client.events') }}" class="flex flex-wrap gap-4">
            {{-- Search input --}}
