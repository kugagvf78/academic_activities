...
<section class="container mx-auto px-6 py-16">
    <div class="grid lg:grid-cols-4 gap-8" x-data="{ tab: 'info' }">
        ...
        <aside class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6 text-center">
                <div class="relative inline-block mb-4">
                    <img src="{{ asset('images/default-avatar.png') }}" 
                         class="w-24 h-24 rounded-full border-4 border-blue-100 object-cover mx-auto" 
                         alt="Avatar">
            ...
            {{-- Navigation Menu --}}
            <nav class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                <button @click="tab='info'" 
                    :class="tab==='info' ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-600' : 'text-gray-700 hover:bg-gray-50'"
                    class="w-full px-6 py-4 flex items-center gap-3 font-medium transition text-left">
                ...
                <button @click="tab='activities'" 
                    ...
                    class="w-full px-6 py-4 flex items-center gap-3 font-medium transition text-left border-t border-gray-100">
                ...
                <a href="#" class="w-full px-6 py-4 flex items-center gap-3 font-medium transition text-left border-t border-gray-100 text-red-600 hover:bg-red-50">
            ...
            {{-- Quick Stats --}}
            <div class="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl shadow-md p-6 text-white">
