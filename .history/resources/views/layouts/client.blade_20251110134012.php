...
<head>
    ...
    @vite(['resources/css/app.css'])  {{-- load css trước --}}
    @vite(['resources/js/app.js'])   {{-- load js sau --}}
    {{-- Base Animations --}}
    <style>
        @keyframes float {
    ...
    <header class="bg-white backdrop-blur-md shadow sticky top-0 z-50 border-b border-gray-100">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                @else
                <a href="{{ route('login') }}" class="px-5 py-2 rounded-lg bg-blue-600 text-white font-semibold">
