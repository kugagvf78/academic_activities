    ...
    <div class="grid lg:grid-cols-4 gap-8 relative" x-data="{ tab: 'info' }">
        ...
        <main class="lg:col-span-3">
            ...
            <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-8">
                ...
                {{-- HEADER --}}
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4 border-b border-gray-100 pb-5">
                    <div>
                        <h3 class="text-2xl font-bold text-gray-800">Hoạt động học thuật</h3>
                        <p class="text-gray-500 text-sm mt-1">Theo dõi, quản lý và lọc các hoạt động bạn đã tham gia</p>
                    </div>
                ...
                <div class="grid sm:grid-cols-3 gap-4 mb-8">
                    ...
                    <div class="relative col-span-2">
                        ...
                        <input type="text" placeholder="Tìm kiếm theo tên hoạt động..."
