...
<section
    ...
    <template x-for="(slide, index) in slides" :key="index">
        <div x-show="active === index"
            ...
            <img :src="slide" class="w-full h-full object-cover brightness-[0.75]">
        </div>
    </template>

    {{-- Controls --}}
    <button @click="active = active === 0 ? slides.length - 1 : active - 1"
        class="absolute left-6 top-1/2 -translate-y-1/2 bg-white/25 hover:bg-white/40 text-white rounded-full w-11 h-11 flex items-center justify-center transition">
        <i class="fa-solid fa-chevron-left"></i>
    </button>

    <button @click="active = active === slides.length - 1 ? 0 : active + 1"
        class="absolute right-6 top-1/2 -translate-y-1/2 bg-white/25 hover:bg-white/40 text-white rounded-full w-11 h-11 flex items-center justify-center transition">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="grid gap-6 ml-5">
                ...
                <div class="relative group rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                    <img src="https://source.unsplash.com/600x400/?ai,students"
                ...
                {{-- Event 2 --}}
                <div class="relative group rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                    <img src="https://source.unsplash.com/600x400/?web,design,team"
                        class="w-full h-60 object-cover group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-5 text-white">
        ...
        <div class="grid lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
            ...
            <div class="space-y-6">
                ...
                <div class="flex space-x-3 pt-2">
                    @foreach (['facebook-f', 'linkedin-in', 'youtube', 'instagram'] as $icon)
                    <a href="#"
                        class="w-10 h-10 flex items-center justify-center bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white rounded-lg transition">
            ...
            <div class="lg:col-span-2">
                <form class="bg-white border border-gray-200 rounded-3xl p-8 shadow-md hover:shadow-lg transition space-y-6">
                    ...
                    {{-- Nội dung --}}
                    <div class="mb-6">
                        <label class="block text-xs font-semibold text-gray-700 mb-2">Nội dung <span class="text-red-500">*</span></label>
