...
<section class="container mx-auto px-6 -mt-8 relative z-20">
    <div class="bg-white rounded-2xl shadow-xl border border-blue-100 p-6">
        <form method="GET" action="{{ route('client.events') }}" class="grid grid-cols-5 gap-6 items-end">
            ...
            <div class="relative">
                <select name="status"
                    class="appearance-none w-full px-4 py-3 border border-gray-200 focus:outline-none rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white pr-10">
            ...
            <div class="relative">
                <select name="category"
                    class="appearance-none w-full px-4 py-3 border focus:outline-none border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white pr-10">
