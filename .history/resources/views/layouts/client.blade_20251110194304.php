    ...
    <header x-data="{ openMenu: false }" class="bg-white backdrop-blur-md shadow sticky top-0 z-50 border-b border-gray-100">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <div class="hidden lg:flex items-center space-x-4">
                @auth
                {{-- dùng x-ignore để Alpine không re-render khi openMenu thay đổi --}}
                <div class="relative" x-data="{ open: false }" x-ignore>
                    <button @click.stop="open = !open" class="flex items-center space-x-2">
                        <div
        ...
        <div x-show="openMenu"
            ...
            <div class="relative bg-white w-4/5 sm:w-2/5 h-full shadow-xl p-6 flex flex-col">
                ...
                <nav class="mt-12 flex flex-col space-y-5 text-lg font-medium text-gray-700">
                    ...
                    <a href="{{ route('client.events') }}"
                        class="hover:text-blue-600 {{ request()->routeIs('client.events') ? 'font-bold text-blue-600' : '' }}">
                        Cuộc thi
                    </a>
                    <a href="#"
