        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-7 max-w-xl">
                ...
                <h1 class="text-5xl md:text-6xl xl:text-7xl font-black text-gray-900">
                    <span class="block mb-2">Quản lý</span>
                    <span class="block mb-2 text-blue-600">Hội thảo CNTT</span>
...
<section id="about" class="relative py-24  overflow-hidden bg-gradient-to-b from-gray-50 to-white">
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-20">
            ...
            <h2 class="text-5xl md:text-6xl font-black text-gray-900 mb-6 leading-[1.7] tracking-tight">
                <span class="block mb-1">Hệ thống Quản lý Hội thảo</span>
                <span class="block bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-500 bg-clip-text text-transparent">
