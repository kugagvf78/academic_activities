        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-7 max-w-xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('.events') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-7 py-3.5 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
