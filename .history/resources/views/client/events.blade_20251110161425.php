        ...
        <form class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-4 items-end">
            ...
            <div class="col-span-2 relative">
                ...
                <input type="text" placeholder="Tìm kiếm cuộc thi..."
                    class="w-full pl-12 pr-4 pb-2 pt-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            </div>
