...
<section class="relative bg-gradient-to-br from-slate-800 via-blue-900 to-slate-800 text-white py-24 overflow-hidden">
...
<section class="container mx-auto px-6 py-16">
    <div class="grid lg:grid-cols-3 gap-10">
        ...
        <aside class="space-y-6">
            ...
            {{-- Quick info card --}}
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-22">
