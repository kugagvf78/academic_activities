...
<section
    ...
    <template x-for="(slide, index) in slides" :key="index">
        <div x-show="active === index"
            ...
            <img :src="slide" class="w-full h-full object-cover brightness-[0.9]">
        </div>
    </template>
    ...
    <div class="container mx-auto relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-7 max-w-xl">
                ...
                {{-- Heading --}}
                <h1 class="md:text-6xl xl:text-7xl font-black text-gray-900 leading-tight">
                    <span class="block text-5xl mb-2 text-blue-700">Cuộc thi Học thuật</span>
