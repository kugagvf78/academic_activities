...
{{-- HERO SECTION - Dành cho sinh viên --}}
    ...
    <div class="container mx-auto px-6 py-20 md:py-28 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="hidden lg:flex justify-center items-center">
                <img src="{{ asset('images/home/student_hero.png') }}"
                     alt="Sinh viên CNTT tham gia cuộc thi"
                     class="w-[85%] max-w-lg animate-float drop-shadow-xl">
            </div>
        </div>
    </div>
