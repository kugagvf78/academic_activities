...
<section x-data="{ active: 0, slides: [
    ...
    { img: '{{ asset('images/home/banner2.jpg') }}', title: 'Nơi Kết Nối Sinh Viên Đam Mê Công Nghệ', subtitle: 'Học hỏi – Cạnh tranh – Phát triển cùng bạn bè đồng khoa', button: 'Xem Cuộc Thi' },
