    ...
    <div class="container mx-auto px-6 py-20 md:py-28 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-7 max-w-xl">
                ...
                <!-- Main Heading -->
                <h1 class="text-5xl md:text-6xl font-black text-gray-900 leading-relaxed tracking-tight">
                    <span class="block">Quản lý</span>
                    <span class="block text-blue-600">Hội thảo CNTT</span>
                    <span class="block">Dễ dàng – Hiệu quả</span>
                </h1>
