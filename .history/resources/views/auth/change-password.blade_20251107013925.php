...
@section('content')
<div class="flex items-center justify-center min-h-screen bg-gray-50  w-50">
    <div class="max-w-full mx-auto mt-10 p-6 bg-white rounded-xl shadow-md border border-gray-200">
