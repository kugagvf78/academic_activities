        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-white/90 text-sm">Tạo cuộc thi</span>
                </div>
                <h1 class="text-4xl font-black mb-2">
                    Tạo cuộc thi mới
                </h1>
                <p class="text-cyan-100">Điền thông tin để tạo cuộc thi mới</p>
            </div>
            <div class="hidden md:block">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-center">
                        <i class="fas fa-trophy text-4xl mb-2"></i>
                        <div class="text-sm text-cyan-100">Cuộc thi mới</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="container mx-auto px-6 -mt-8 relative z-20 pb-12">
    <form method="POST" action="{{ route('giangvien.cuocthi.store') }}">
        @csrf
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <select name="loaicuocthi" required
                                ...
                                <option value="CuocThi" {{ old('loaicuocthi') == 'CuocThi' ? 'selected' : '' }}>Cuộc thi</option>
                                <option value="HoiThao" {{ old('loaicuocthi') == 'HoiThao' ? 'selected' : '' }}>Hội thảo</option>
                            </select>
                            @error('loaicuocthi')
                                <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                    <i class="fas fa-exclamation-circle"></i>{{ $message }}
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 shadow-md">
                    ...
                    <ul class="space-y-3 text-sm text-gray-700">
                        ...
                        <li class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-500 mt-0.5"></i>
                            <span>Chọn thời gian phù hợp cho cuộc thi</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-500 mt-0.5"></i>
                            <span>Mô tả rõ ràng mục đích và đối tượng</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-500 mt-0.5"></i>
                            <span>Xác định hình thức tham gia phù hợp</span>
                        </li>
                    </ul>
                </div>
            </div>
