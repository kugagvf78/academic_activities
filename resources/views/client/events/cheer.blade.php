...
@section('title', 'Đăng ký cổ vũ - ' . $cuocthi->tencuocthi)
...
<section class="relative bg-gradient-to-br from-blue-700 via-blue-600 to-cyan-500 text-white pt-24 pb-28 overflow-hidden">
    <div class="container mx-auto px-6 text-center relative z-10">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4">Đăng ký cổ vũ</h1>
        <p class="text-blue-100 text-lg mb-6">{{ $cuocthi->tencuocthi }}</p>
        <p class="text-blue-50 text-base">Lan tỏa tinh thần học thuật và nhiệt huyết 💙</p>
    </div>
...
<section class="container mx-auto px-6 py-16">
    @if($hoatdongs->isEmpty())
        ...
        <div class="max-w-2xl mx-auto text-center py-16">
            <div class="bg-white rounded-2xl shadow-lg p-12 border border-gray-100">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-3">Chưa có hoạt động cổ vũ</h3>
                <p class="text-gray-600 mb-6">Cuộc thi này hiện chưa có hoạt động cổ vũ nào được mở đăng ký.</p>
    ...
    @else
        <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-10"
            ...
            <form action="{{ route('client.events.cheer.submit', $slug) }}" method="POST">
                @csrf

                {{-- Chọn hoạt động cổ vũ --}}
                <div class="mb-8">
                    <label class="block font-semibold text-gray-700 mb-3">
                        Chọn hoạt động cổ vũ <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="mb-8 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6">
                    ...
                    <ul class="space-y-2 text-gray-700 text-sm">
                        ...
                        <li class="flex items-start gap-2">
                            <i class="fa-solid fa-check text-green-600 mt-1"></i>
                            <span>Đảm bảo thông tin chính xác để nhận được thông báo</span>
                        </li>
                    </ul>
                </div>
