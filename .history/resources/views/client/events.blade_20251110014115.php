...
<section class="container mx-auto px-6 -mt-8 relative z-20">
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 gap-4 items-end gap-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 ">
        <form method="GET" action="{{ route('client.events') }}" class="flex flex-wrap gap-4 col-span-1">
            {{-- Search input --}}
            <div class="flex-1 min-w-[250px] relative w-full">
                <div class="relative">
