    ...
    Route::get('/{id}', function ($id) {
        $result = (object) [
            ...
            'rounds' => [
                ...
                ['name' => 'Vòng Chung kết', 'winner' => 'Đội Team SQL Pro'],
            ],
            'top3' => [
                ['name' => 'Nguyễn Văn A', 'rank' => 'Giải Nhất', 'score' => 98],
                ['name' => 'Trần Thị B', 'rank' => 'Giải Nhì', 'score' => 93],
                ['name' => 'Team SQL Pro', 'rank' => 'Giải Ba', 'score' => 88],
            ]
        ];
