    ...
    <header class="bg-white/90 backdrop-blur-md shadow sticky top-0 z-50 border-b border-gray-100">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <nav class="hidden md:flex space-x-8 font-medium">
                <a href="{{ route('client.home') }}#contact" class="nav-link hover:text-blue-600">Trang chủ</a>
                <a href="{{ route('client.events') }}#contact" class="nav-link hover:text-blue-600">Cuộc thi</a>
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <a href="#" class="block px-4 py-2 hover:bg-blue-50">Hồ sơ cá nhân</a>
                        <a href="{{ route('password.change') }}" class="block px-4 py-2 hover:bg-blue-50">Đổi mật khẩu</a>
