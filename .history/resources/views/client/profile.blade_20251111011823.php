...
<section class="container mx-auto px-6 py-8">
    <div class="grid lg:grid-cols-4 gap-8 relav" x-data="{ tab: 'info' }">

        {{-- 👤 LEFT SIDEBAR - Profile Section (Profile Card + Navigation Menu) --}}
        <aside class="lg:col-span-1 sticky">
            <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">

                {{-- Profile Header --}}
                <div class="px-6 pb-3 pt-6 text-center border-b border-gray-300 mx-4 ">
