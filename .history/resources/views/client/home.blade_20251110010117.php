    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-20">
            ...
            <h2 class="text-5xl md:text-6xl font-black text-gray-900 mb-6 leading-[1.3] tracking-tight">
                <span class="block mb-3">Hệ thống Quản lý Cuộc thi Học thuật</span>
            ...
            <p class="max-w-2xl mx-auto text-gray-600 text-lg">
                Nền tảng giúp Khoa CNTT tổ chức, quản lý và theo dõi các cuộc thi học thuật một cách chuyên nghiệp — 
                hỗ trợ giảng viên, sinh viên và ban tổ chức làm việc hiệu quả, minh bạch và hiện đại.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-20">
            ...
            <div class="group relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-8 overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="relative">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Tổ chức & Quản lý Cuộc thi</h3>
                    <p class="text-blue-50 leading-relaxed">
                        Quản lý toàn bộ quy trình từ khâu lập kế hoạch, mở đăng ký, tổ chức thi, chấm điểm đến công bố kết quả.
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-3xl p-8 overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="relative">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Quản lý Thí sinh & Giảng viên</h3>
                    <p class="text-cyan-50 leading-relaxed">
                        Theo dõi thông tin thí sinh, giảng viên hướng dẫn, điểm số và trạng thái tham gia trong từng cuộc thi.
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-3xl p-8 overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="relative">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Thống kê & Báo cáo Kết quả</h3>
                    <p class="text-indigo-50 leading-relaxed">
                        Hệ thống tự động tổng hợp dữ liệu, xuất báo cáo về số lượng thí sinh, điểm số, giải thưởng và đánh giá chất lượng cuộc thi.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <p class="text-gray-600 text-sm">
                    Gửi thông báo về lịch thi, thay đổi, kết quả và giải thưởng tới sinh viên và giảng viên nhanh chóng.
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <h4 class="font-bold text-lg mb-2 text-gray-900">Lưu trữ dữ liệu cuộc thi</h4>
                <p class="text-gray-600 text-sm">
                    Lưu trữ toàn bộ dữ liệu cuộc thi: thông tin thí sinh, kết quả, bài dự thi và lịch sử tham gia.
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <h4 class="font-bold text-lg mb-2 text-gray-900">Cấp chứng nhận & Giải thưởng</h4>
                <p class="text-gray-600 text-sm">
                    Tự động cấp giấy chứng nhận hoặc xác nhận thành tích cho sinh viên đạt giải trong cuộc thi.
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <h4 class="font-bold text-lg mb-2 text-gray-900">Phân quyền & Quản trị</h4>
                <p class="text-gray-600 text-sm">
                    Quản lý quyền truy cập cho Ban tổ chức, giảng viên, sinh viên — đảm bảo tính bảo mật và rõ ràng.
                </p>
            </div>
        </div>
    </div>
