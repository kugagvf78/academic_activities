...
<section class="container mx-auto px-6 py-16">
    <div class="grid lg:grid-cols-3 gap-10">
        ...
        <aside class="space-y-6">
            {{-- Thông tin nhanh --}}
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28 bottom-[300px]">
            ...
            {{-- Gợi ý khác --}}
            <div class="bg-gradient-to-r from-blue-700 to-cyan-500 text-white p-6 sticky top-[337px] rounded-2xl shadow-md">
