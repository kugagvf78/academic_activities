...
// Gắn toàn cục để Blade có thể gọi trực tiếp
window.Swal = Swal;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Nếu URL có #contact khi load (VD: từ trang khác chuyển về)
  if (window.location.hash === "#contact") {
    setTimeout(scrollToContact, 500); // ⏳ đợi nửa giây để DOM sẵn sàng
  }

  // Nếu click vào link Liên hệ trong header (khi đang ở trang chủ)
