    ...
    <header class="bg-white/90 backdrop-blur-md shadow sticky top-0 z-50 border-b border-gray-100">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <nav class="hidden md:flex space-x-8 font-medium">
                ...
                <a href="{{ route('client.results') }}" class="nav-link hover:text-blue-600">Kết quả</a>
                <a href="{{ route('client.news') }}" class="nav-link hover:text-blue-600">Tin tức</a>
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <a href="{{ route('profile') }}" class="block px-4 py-2 hover:bg-blue-50">Hồ sơ cá nhân</a>
