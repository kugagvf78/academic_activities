                ...
                <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 text-center">
                    ...
                    <div class="relative bg-gradient-to-b from-white to-blue-50 border border-gray-100 rounded-2xl p-6 hover:shadow-md transition">
                        ...
                        <div class="pt-8">
                            ...
                            <p class="text-sm text-gray-500 mb-1">{{ $t['rank'] }}</p>

                            {{-- Điểm --}}
                            <span class="inline-block bg-blue-100 text-blue-700 text-xs px-3 py-1 rounded-full font-semibold mb-2">
                                {{ $t['score'] }} điểm
                            </span>

                            {{-- Giải thưởng --}}
                            <p class="text-sm text-gray-600 mt-1">
                                <i class="fa-solid fa-gift text-pink-500 mr-1"></i> {{ $t['prize'] }}
                            </p>
                        </div>
