        ...
        <div class="group bg-white rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-2">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#"
                        class="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-md hover:shadow-lg transition">
                        Xem chi tiết
                    </a>
                </div>
            </div>
