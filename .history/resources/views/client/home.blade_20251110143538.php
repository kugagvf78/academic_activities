...
<section 
    x-data="{
        active: 0,
        slides: [
            '{{ asset('images/home/banner1.pnh') }}',
            '{{ asset('images/home/banner2.jpg') }}',
    ...
    <template x-for="(slide, index) in slides" :key="index">
        <div x-show="active === index"
            ...
            <div class="relative w-full h-full">
                <img :src="slide"
                     class="w-full h-full object-cover brightness-[0.45] transition-transform duration-[5000ms] scale-100 group-[.active]:scale-105">
            </div>
        </div>
    </template>
