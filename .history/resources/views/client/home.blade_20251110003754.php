...
<section class="border-y border-blue-100 bg-white">
    <div class="container mx-auto px-6 py-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4">
            ...
            <div class="mt-3 sm:mt-0">
                <h3 class="text-2xl font-bold text-blue-700">150+</h3>
                <p class="text-gray-600 text-sm font-medium">Hội thảo</p>
            </div>
        </div>

        {{-- 2️⃣ Sinh viên --}}
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4 border-t sm:border-t-0 sm:border-l border-blue-100">
            <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 text-blue-600 shadow-inner">
                <i class="fa-solid fa-user-graduate text-xl"></i>
            </div>
            <div class="mt-3 sm:mt-0">
                <h3 class="text-2xl font-bold text-blue-700">2.5K+</h3>
                <p class="text-gray-600 text-sm font-medium">Sinh viên</p>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4 border-t sm:border-t-0 sm:border-l border-blue-100">
            ...
            <div class="mt-3 sm:mt-0">
                <h3 class="text-2xl font-bold text-blue-700">80+</h3>
                <p class="text-gray-600 text-sm font-medium">Giảng viên</p>
            </div>
        </div>
