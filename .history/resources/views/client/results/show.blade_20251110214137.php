...
<section class="relative bg-gradient-to-br from-blue-700 via-blue-600 to-cyan-500 text-white py-24 overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-10">
        <div class="absolute inset-0" style="background-image: linear-gradient(45deg, rgba(255,255,255,0.2) 25%, transparent 25%, transparent 75%, rgba(255,255,255,0.2) 75%, rgba(255,255,255,0.2)),
    ...
    {{-- Floating circles --}}
    <div class="absolute -top-20 left-10 w-80 h-80 bg-cyan-400/20 rounded-full blur-3xl"></div>
    <div class="absolute bottom-10 right-10 w-72 h-72 bg-white/10 rounded-full blur-2xl"></div>

    <div class="container mx-auto px-6 relative z-10 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">{{ $result->title }}</h1>
        <p class="text-blue-100 text-lg mb-2"><i class="fa-regular fa-calendar mr-2"></i>Ngày tổ chức: {{ $result->date }}</p>
        <p class="text-blue-100 text-sm italic">Vinh danh những gương mặt xuất sắc nhất trong lĩnh vực học thuật Khoa CNTT</p>
    </div>

    {{-- Wave --}}
    <div class="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
            <path d="M0 100L80 85C160 70 320 40 480 35C640 30 800 50 960 65C1120 80 1280 90 1360 95L1440 100V0H0V100Z" fill="white"/>
        </svg>
    </div>
</section>
    ...
    <div class="grid lg:grid-cols-3 gap-10">
        ...
        <aside class="space-y-6">
            ...
            <div class="bg-gradient-to-r from-blue-700 to-cyan-500 text-white p-6 rounded-2xl shadow-md">
                ...
                <a href="{{ route('client.events') }}" class="inline-block bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition">
