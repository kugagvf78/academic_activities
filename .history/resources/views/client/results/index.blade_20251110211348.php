        ...
        @for ($i = 1; $i <= 6; $i++)
            <article class="group bg-white rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 hover:-translate-y-3">
                <div class="relative overflow-hidden h-56">
                    <img src="https://source.unsplash.com/600x400/?trophy,award,{{ $i }}"
                        alt="Kết quả {{ $i }}"
                ...
                <div class="p-6">
                    ...
                    <div class="border-t border-gray-100 pt-4 flex items-center justify-between">
                        ...
                        <a href="{{ route('client.results.show', $i) }}"
...
<section class="bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-500 py-16 text-white text-center">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            <a href="{{ route('client.events.i') }}" class="bg-white text-blue-700 px-8 py-4 rounded-xl font-bold shadow-lg hover:shadow-xl transition inline-flex items-center gap-2">
