...
<section class="border-y border-gray-200 mx-[100px] bg-white">
    <div class="container mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4">
            <div class="flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 shadow-inner overflow-hidden">
                <img src="{{ asset('images/home/seminar.png') }}" alt="Hội thảo" class="w-10 h-10 object-contain">
            </div>
        ...
        {{-- 2️⃣ Sinh viên --}}
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4 border-t sm:border-t-0 sm:border-l border-gray-200">
            <div class="flex items-center justify-center  rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 shadow-inner overflow-hidden">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-center sm:space-x-4 border-t sm:border-t-0 sm:border-l border-gray-200">
            <div class="flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 shadow-inner overflow-hidden">
                <img src="{{ asset('images/home/teacher.png') }}" alt="Giảng viên" class="w-10 h-10 object-contain">
            </div>
            <div class="mt-3 sm:mt-0">
