...
<section class="relative bg-gradient-to-br px-10 from-blue-50 via-white to-cyan-50 overflow-hidden">
    ...
    <div class="container mx-auto px-6 py-20 md:py-28 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {{-- Right visual - minh họa động cho sinh viên CNTT --}}
            <div class="hidden lg:flex justify-center items-center relative">
                {{-- Nền bo tròn --}}
                <div class="absolute w-96 h-96 bg-gradient-to-br from-blue-100 via-cyan-100 to-white rounded-full blur-2xl opacity-50 animate-pulse"></div>

                {{-- Card chính --}}
                <div class="relative bg-white rounded-3xl shadow-xl p-8 border border-blue-100 z-10 w-[380px] hover:shadow-2xl transition-all duration-500">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-12 h-12 bg-gradient-to-tr from-blue-600 to-cyan-500 rounded-2xl flex items-center justify-center shadow-md">
                            <i class="fa-solid fa-laptop-code text-white text-xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-lg text-gray-800">Lập trình Web</h3>
                            <p class="text-sm text-gray-500">Khoa Công nghệ Thông tin</p>
                        </div>
                    </div>

                    <div class="space-y-4">
                        <div class="flex items-center justify-between bg-blue-50 border border-blue-100 rounded-xl px-4 py-2">
                            <span class="text-gray-700 text-sm font-semibold flex items-center gap-2">
                                <i class="fa-solid fa-users text-blue-500"></i> Đội thi: <span class="text-blue-600">CodeHustlers</span>
                            </span>
                            <span class="text-xs text-green-600 font-medium">Đang thi</span>
                        </div>

                        <div class="flex items-center justify-between bg-cyan-50 border border-cyan-100 rounded-xl px-4 py-2">
                            <span class="text-gray-700 text-sm font-semibold flex items-center gap-2">
                                <i class="fa-solid fa-calendar text-cyan-500"></i> Ngày thi: <span class="text-cyan-600">20/11/2025</span>
                            </span>
                            <i class="fa-solid fa-clock text-cyan-400"></i>
                        </div>

                        <div class="flex items-center justify-between bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-2">
                            <span class="text-gray-700 text-sm font-semibold flex items-center gap-2">
                                <i class="fa-solid fa-award text-indigo-500"></i> Giải thưởng:
                            </span>
                            <span class="text-indigo-600 font-bold">20.000.000đ</span>
                        </div>
                    </div>

                    <button class="w-full mt-8 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-bold py-3 rounded-xl transition-all hover:scale-105 shadow-md">
                        <i class="fa-solid fa-rocket mr-2"></i> Đăng ký ngay
                    </button>
                </div>

                {{-- Hiệu ứng biểu tượng bay --}}
                <div class="absolute top-10 right-10 text-blue-500/30 text-5xl animate-float-slow">
                    <i class="fa-solid fa-code-branch"></i>
                </div>
                <div class="absolute bottom-12 left-10 text-cyan-500/30 text-5xl animate-float">
