...
<div class="flex items-center justify-center min-h-screen bg-gray-50  ">
    <div class="max-w-md w-full mx-auto p-5 bg-white rounded-xl shadow-sm border border-gray-300">
        <div class="bg-white p-8 rounded-xl">
            ...
            {{-- FORM --}}
            <form method="POST" action="{{ route('login.post') }}" class="mb-6" novalidate onsubmit="toggleLoadingSpinner(true)">
                @csrf
